...
.setDescription(`**Açılan Kanal Koruma Sistem Bilgilendirmesi**\n *Açılan kanalları anında kapatır ama açan kişiye müdahalede bulunmaz.*\n`)
.addField(`**Nasıl Açacağım?**`,"`v!açılan-kanal-koruma aç`\n")
.addField(`**Nasıl Kapatacağım?**`,"`v!açılan-kanal-koruma kapat`")
