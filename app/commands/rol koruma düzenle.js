...
.setDescription(`**Düzenlenen Rol Koruma Sistem Bilgilendirmesi***\n *Düzenlenen rolleri eski haline getirir.*\n`)
.addField(`**Nasıl Açacağım?**`,"`v!düzenlenen-rol-koruma aç`\n")
.addField(`**Nasıl Kapatacağım?**`,"`v!düzenlenen-rol-koruma kapat`")
