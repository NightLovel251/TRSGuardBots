...
.setDescription(`**Açılann Rol Koruma Sistem Bilgilendirmesi**\n *Açılan rolleri otomatik olarak kapatır.*\n`)
.addField(`**Nasıl Açacağım?**`,"`v!açılan-rol-koruma aç`\n")
.addField(`**Nasıl Kapatacağım?**`,"`v!açılan-rol-koruma kapat`")
