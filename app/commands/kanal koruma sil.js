...
.setDescription(`**Silinen Kanal Koruma Sistem Bilgilendirmesi**\n *Silinen kanalları yeniden oluşturur ve silenin tüm rollerini alır.*\n`)
.addField(` **Nasıl Açacağım?**`,"`v!silinen-kanal-koruma aç`\n")
.addField(` **Nasıl Kapatacağım?**`,"`v!silinen-kanal-koruma kapat`")
