...
.setDescription(`**Silinen Rol Koruma Sistem Bilgilendirmesi**\n *Silinen rolleri yeniden oluşturur ve silenin tüm rollerini alır.*\n`)
.addField(`**Nasıl Açacağım?**`,"`v!silinen-rol-koruma aç`\n")
.addField(`**Nasıl Kapatacağım?**`,"`v!silinen-rol-koruma kapat`")
