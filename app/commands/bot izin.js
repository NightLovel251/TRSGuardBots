...
.setColor('BLUE')
.setDescription(`<a:yes:793101776651681813> **${botid} \`ID\`'li botun izni devam ediyor.**`)
...
.setColor('BLUE')
.setDescription(`<a:yes:793101776651681813> **${botid}** ID'li bota **${message.guild.name}** sunucusunda **${message.author}** tarafından izin verildi.`)
  .setAuthor(`${message.author.tag} tarafından istendi.`, message.author.avatarURL({dynamic: true,format: "gif",format: "png",format: "jpg",size: 2048}))
    .setFooter(client.user.username,client.user.avatarURL({dynamic: true,format: "gif",format: "png",format: "jpg",size: 2048}))
      .setTimestamp()
